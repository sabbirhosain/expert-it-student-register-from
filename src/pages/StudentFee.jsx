...
import AddStudentFee from '../components/StudentFee/AddStudentFee';
        ...
        <Layout>
            <section className=''>
                ...
                <div className='d-flex align-items-center justify-content-between bg-white p-3 my-2'>
                    <h4>Students Fee</h4>
                    <button className='btn btn-outline-dark rounded-0' data-bs-toggle="modal" data-bs-target="#exampleModal">Add Fee</button>
                </div>
